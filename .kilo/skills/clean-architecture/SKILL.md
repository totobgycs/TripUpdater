...
6. **Enforce architecture with tests** — Use NetArchTest to ensure no forbidden dependencies exist between layers. For example, Domain should never reference Infrastructure.
