...
public class TripEndpointsIntegrationTests(ApiFixture fixture) : IClassFixture<ApiFixture>
{
    ...
    private sealed record TripDto(int TripId, long LineId, int LineNo, DateTimeOffset DepartureTime, DateTimeOffset OriginalArrivalTime, DateTimeOffset? ArrivalTime, int Status);
}
